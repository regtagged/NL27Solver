...
/**
 * Standing pat is only on offer with a jack or better.
 *
 * Not an abstraction - a rule of the game as it is played. A pat king is far
 * too weak to keep, a pat queen is seldom kept, and patting realistically
 * starts at the jack. Without this the equity arithmetic will occasionally
 * prefer sitting on a king-high rather than drawing one to four of a suit,
 * which is a play nobody makes.
 */
const patCeiling = () => rank27(parseHand('Jc Td 9h 8s 6c'));
